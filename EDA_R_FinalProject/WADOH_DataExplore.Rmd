...
gg2 <- arrange(vaccReported_NLT100,desc(percent_nonmedexempt))

#should probably add a filter to get rid of situations where total exemptions > enrolled or nonmedical exempitons > total exemptions
