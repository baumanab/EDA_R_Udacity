...
melt_county_group$students[melt_county_group$school_county == "WHATCOM"]

melt_county_group$students[melt_county_group$school_county == "FERRY"]


melt_county_group$students[melt_county_group$school_county == "SAN JUAN"]

melt_county_group$students[melt_county_group$school_county == "STEVENS"]
...
test <- subset(melt_county_group, mean_percent_exempt_quartile == 4)
