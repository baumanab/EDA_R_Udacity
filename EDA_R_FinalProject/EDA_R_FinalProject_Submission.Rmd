...
plotone_2 <- ggplot(data = vaccReported_NGT50_exemptrate, aes(x = percent_exempt, y = percent_nonmedexempt)) +
  geom_point(alpha = .5) +
  geom_smooth(aes(color = school_year), size = 1.2) +
  theme(legend.position = c(.3,.8),axis.title.x = element_blank(),legend.direction = "horizontal",legend.title=element_blank(),legend.background= element_rect(fill = "grey90")) +
  xlab("") +
  ylab("% Non-medical")
...
* MMR vaccine exemption rates do not track 1:1 with total vaccine exemption rates, it appears that people are choosy about what they don't get vaccinated for.
* Something about school types, acually read through your assement at each sectoin and pick some stuff
...
* look at list and put in some more stuff
