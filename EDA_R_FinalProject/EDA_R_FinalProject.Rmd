...
####2012####
```{r add, rename, select columns 2012}
#add year
doh_k12_2012$year <- 2012
colnames(doh_k12_2012)

#rename columns
colnames_2012 = c('school_code','school_name','school_type','school_district','school_county','reported','grade_levels',"data_source",'enrolled',"complete",'exempt','medical_exempt','personal_exempt','religious_exempt','religious_member_exempt','exempt_DTTd','exempt_pertussis','exempt_polio','exempt_MMR','exempt_hepB','exempt_varicella','year')
