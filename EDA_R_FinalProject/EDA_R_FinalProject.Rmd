...
#change filed name of exempt to total_exemptions, to avoid confusion
...
WA_DOH_combined$percent_exempt_hepB <- round((WA_DOH_combined$exempt_hepB/WA_DOH_tidy$enrolled)*100,digits = 2)
