...
#add columns to 2012:
doh_k12_2012$school_street = 'placeholder'
doh_k12_2012$school_city = 'placeholder'
doh_k12_2012$distric_code = 0000
```
...
colnames_2012 = c('school_code','school_name','school_type','school_district','school_county','reported','grade_levels','enrolled','exempt','medical_exempt','personal_exempt','religious_exempt','religious_member_exempt','exempt_DTTd','exempt_pertussis','exempt_polio','exempt_MMR','exempt_hepB','exempt_varicella','year','district_code','school_street','school_city')
