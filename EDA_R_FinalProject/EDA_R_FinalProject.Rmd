...
####School Code Audit####
Going to try subset on this.  I will subset 2012 and 2013 on those school codes != to 2011, if any.
```{r School Code Audit}
#2012 Unique School Code
schoolcode_2012_unique<- subset(doh_k12_2012, doh_k12_2012$School.Code != doh_k12_2011$School.Code)

  
#2013 Unique School Code
schoolcode_2013_unique<- subset(doh_k12_2013, doh_k12_2013$ != doh_k12_2011$School.Code)
```
