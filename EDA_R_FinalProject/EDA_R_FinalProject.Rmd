...
doh_k12_2012$district_code <- apply(doh_k12_2012[,c("school_code"), drop = F],1, function(x) {final_codeframe$district_code[final_codeframe$school_code == x]})
...
```
####Note on handling numeric(0), character(0), and 8675309 placeholder####
- will handle these in final WA DOH DF
- will likely leave numeric(0) and character(0) as is
...
###Assemble combined WA DOH dataframe###

```{r}

#rename 2012 column "state" --> "school_state"
names(doh_k12_2012)[20] <- "school_state"
#grab 2011 column names
reorder_colnames <- c(names(doh_k12_2011))
#reorder and match names


#rbind

#subset rows with 8675309 district code placeholder
